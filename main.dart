...
class Content extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Counter('6488210'),
        Counter('Ravikarn Jarungjitvittawas'),
        Counter('HomeAlert'),
        Counter('6488120 6488179 6488181 6488210'),
      ],
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border.all(color: Color.fromARGB(255, 98, 2, 253)),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: Color.fromARGB(255, 98, 2, 253),
          borderRadius: BorderRadius.circular(4.0),
        ),
        child: Center(
          child: Text(
